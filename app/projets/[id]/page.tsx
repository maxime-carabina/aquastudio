...
function LeftColSticky({
  ...
  return (
    <div className="w-[493px] h-fit lg:sticky lg:top-[51px] lg:max-h-screen">
    ...
    <div className="text-f-primary">
      <div className="px-[22px] md:px-16 lg:px-28 mt-12 lg:mb-[70px] lg:mt-[74px] text-f-primary">
        <div className="mb-6 lg:mb-[70px] flex flex-wrap items-start justify-between gap-8 antialiased">
          <div>
            <h1 className="mb-8 lg:mb-[30px] aqua-banner text-[60px] leading-[20px] lg:text-[80px] lg:leading-[75px] uppercase max-w-[500px]">
              {name}
            </h1>
          ...
          <div className="aqua-caption lg:text-justify text-[14px] leading-[18px] lg:text-[20px] lg:leading-[21.24px] max-w-[617px] antialiased">
      ...
      <div className="px-[22px] md:px-16 lg:px-[109px]">
        <div className="lg:pt-[70px] lg:pb-[70px] flex flex-wrap md:flex-nowrap justify-center gap-5 lg:gap-[50px] lg:border-b lg:border-t border-primary">
