  ...
  return (
    <main>
      <div className="bg-primary">
        <div className="px-[22px] md:px-16 lg:px-28 pt-5 pb-[35px] lg:pb-[53px] max-w-screen-2xl m-auto">
                    ...
                    <li>
                      ...
                      <div className="pt-2 lg:pt-[23px] pb-10 antialiased">
                        ...
                        <div className="font-GothamLight text-[12px] leading-[14px] lg:leading-[17px] lg:text-[16px]">
                          ...
                          illustrations - PLV - assistance aux shootings -
                          social média
                        </div>
                      </div>
                    </li>
      ...
      <div>
        <div className="pt-8 pb-11 lg:pt-12 lg:pb-36 text-f-primary max-w-screen-2xl m-auto">
      ...
      <div className="bg-primary">
        <div className="px-[22px] py-11 md:px-16 lg:px-20 lg:py-20 text-f-secondary max-w-screen-2xl m-auto">
