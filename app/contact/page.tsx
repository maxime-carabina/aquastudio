  ...
  return (
    <main className="w-full">
      <div className="bg-primary">
        <div className="px-[22px] md:px-16 lg:px-28 pt-5 pb-[35px] lg:pb-[114px] bg-primary min-h-screen lg:min-h-fit max-w-screen-2xl m-auto">
      ...
      <div>
        <div className="lg:pt-14 lg:pb-14 text-f-primary max-w-screen-2xl m-auto">
